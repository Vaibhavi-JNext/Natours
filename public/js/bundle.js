...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmFpYmhhdmktMTIzIiwiYSI6ImNrc2lzOWkwbDA2ZGkyenFvZ2xsZ3pkNjkifQ.bCdjXFPWXRY09QEJ4x4e3g';
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://127.0.0.1:4001/api/v1/users/login',
              data: {
                email: email,
                password: password
              }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:4001/api/v1/users/updatePassword' : 'http://127.0.0.1:4001/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUppercase(), " Data Successfully Updated"));
            }
...
var stripe = Stripe('pk_test_51JRbTXSInBetGapY0MpcIcV7rXo1bNdUKxC6Ke4H6iT53LveMqBbt1LQONQtMHAP8u3NyIqQW8Pb25qNQJCHbhm100MRgfQ6af');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:4001/api/v1/bookings/checkout-session/".concat(tourId));
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var passwordCurrent, password, confirmPswd;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            confirmPswd = document.getElementById('password-confirm').value;
            _context.next = 7;
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.innerHTML = 'Processing..'; // const text = node.textContent;
